...
public class GlobalActionsDialog extends GlobalActionsDialogLite
    ...
    public GlobalActionsDialog(
	    ...
	    IDreamManager iDreamManager,
            ...
            StatusBarWindowControllerStore statusBarOptional,
	...
	mStatusBarWindowController = null;
    ...
    public void destroy() {
        ...
        mGlobalSettings.unregisterContentObserverSync(mSettingsObserver);
    }
    ...
    class ActionsDialog extends ActionsDialogLite {
        ...
        // Define mScrimAlpha for animations
        private static final float DEFAULT_SCRIM_ALPHA = 0.6f;
        private final float mScrimAlpha = DEFAULT_SCRIM_ALPHA;
        ...
        ActionsDialog(Context context, MyAdapter adapter, MyOverflowAdapter overflowAdapter,
                ...
                KeyguardStateController keyguardStateController,
                NotificationShadeWindowController notificationShadeWindowController,
                StatusBarWindowController statusBarWindowController, boolean controlsAvailable,
            ...
            super(context, com.android.systemui.res.R.style.Theme_SystemUI_Dialog_GlobalActions,
                    ...
                    statusBarWindowController, onRotateCallback, keyguardShowing, powerAdapter,
